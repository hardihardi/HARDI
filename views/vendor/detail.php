                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active p-3" id="header" role="tabpanel">
                                                    ...
                                                    <div class="row">
                                                        <?php
                                                            $id = $_GET['id'];
                                                            $data = mysqli_query($con,"SELECT x.Id,x.NoTransaksi,x.Status,c.Code,c.Name,c.NPWP,c.alamat,c.Telpon,c.email FROM `transaksi` x
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                        ...
                                                                        <?php
                                                                                ...
                                                                                $data = mysqli_query($con,"SELECT x.Id,x.seri,x.hs,x.harga,x.kodesatuan,x.jumlahsatuan,y.KodeBarangVendor,y.Nama , t.Status 
                                                                                FROM `detailtransaksi` x 
                                                                                INNER JOIN barang y on x.barang = y.Id
                                                                                INNER JOIN transaksi t  on x.IdTransaksi = t.Id
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a type="button" href="http://localhost:8080/ISAQ/wwwroot/vendor/deleteBarang.php?id=<?php echo $d['Id'];?>&idTrans=<?php echo $id;?>" class="btn btn-outline-danger waves-effect waves-light  alert_notif" ><i class="ion-trash-a"></i></a>
                                                                                <button data-id="<?php echo $d['Id'];?>" class="btn btn-outline-warning waves-effect waves-light edit" ><i class="far fa-edit"></i></button>
                                                                                <?php } ?>
                                                ...
                                                <?php include "modals/AddDetailModal.php"; ?>
                                                <?php include "modals/UploadDetailModal.php"; ?>
                                            </div>
