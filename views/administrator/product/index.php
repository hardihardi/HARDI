                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <?php
                                                    ...
                                                    if ( $_SESSION['role'] === "Administrator") {
                                                        $data = mysqli_query($con,"SELECT x.Id, x.KodeBarang, x.KodeBarangVendor, x.Nama,x.Company as IdCompany, c.Name as CompanyName FROM `barang` X
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="http://localhost:8080/ISAQ/wwwroot/administrator/product/delete.php?id=<?php echo $d['Id'];?>" class="btn btn-outline-danger waves-effect waves-light  alert_notif" ><i class="ion-trash-a"></i></a>
