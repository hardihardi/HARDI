                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="http://localhost:8080/ISAQ/wwwroot/administrator/role/delete.php?id=<?php echo $d['Id'];?>" class="btn btn-outline-danger waves-effect waves-light  alert_notif" ><i class="ion-trash-a"></i></a>
