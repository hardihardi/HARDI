...
$worksheet1->setCellValue('A1', 'NO');
$worksheet1->setCellValue('B1', 'HS');
$worksheet1->setCellValue('C1', 'KODE BARANG');
$worksheet1->setCellValue('D1', 'MEREK');
$worksheet1->setCellValue('E1', 'TIPE');
$worksheet1->setCellValue('F1', 'UKURAN');
$worksheet1->setCellValue('G1', 'SPESIFIKASI LAIN');
$worksheet1->setCellValue('H1', 'JUMLAH SATUAN');
$worksheet1->setCellValue('I1', 'KODE SATUAN');
$worksheet1->setCellValue('J1', 'JUMLAH KEMASAN');
$worksheet1->setCellValue('K1', 'KODE KEMASAN');
$worksheet1->setCellValue('L1', 'VOLUME');
$worksheet1->setCellValue('M1', 'BERAT');
$worksheet1->setCellValue('N1', 'HARGA');
$worksheet1->setCellValue('O1', 'JASA');
$worksheet1->setCellValue('P1', 'DISKON');
$worksheet1->setCellValue('Q1', 'PPN');
$worksheet1->setCellValue('R1', 'KODE FASILITAS');
$worksheet1->setCellValue('S1', 'FASILITAS');
...
// $querySheet2 = "SELECT '' as 'NOMOR AJU'
// ,x.seri as 'SERI BARANG'
